...
\begin{document}
    ...
    \include{Abstract}
    \markboth{}{} % Clear running headers
	\include{chapters/Astroparticleradiodetection}
	\markboth{}{} % Clear running headers
	\include{chapters/Radiopropagationintheatmosphere}
	\markboth{}{} % Clear running headers
	\include{chapters/Implementationofanhydrometeorscatteringmodel}
	\markboth{}{} % Clear running headers
